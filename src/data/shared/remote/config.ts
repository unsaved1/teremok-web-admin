...
export class BaseRemoteDataSource {
    ...
    protected async rpcMultipartCall(path: string, method: string, params = {}, file: File) {
        ...
        const res = await this.http.sendMultipartFormData<Record<string, any>>(path, formData);
